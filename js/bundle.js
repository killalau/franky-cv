...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	    ...
	    window.app = _reactDom2.default.render(_react2.default.createElement(_app2.default, reactState), $('#app')[0]);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _headerNav = __webpack_require__(167);

	var _headerNav2 = _interopRequireDefault(_headerNav);

	var _mainSection = __webpack_require__(168);
	...
	var App = _react2.default.createClass({
	    ...
	    getInitialState: function getInitialState() {
	        var store = new _app2.default(this.props);
	    ...
	    bindStoreChange: function bindStoreChange(state) {
	        state.page.onChange = this.refreshState;
	        state.activeCards.onChange = this.refreshState;
	    },

	    unbindStoreChange: function unbindStoreChange() {
	        this.state.page.onChange = null;
	        this.state.activeCards.onChange = null;
	    },

	    render: function render() {
	        var cardTypesObj = this.state.cards.map(function (v) {
	            return v.type;
	        }).reduce(function (p, c) {
	            p[c] = true;return p;
	        }, {});
	        var cardTypes = Object.keys(cardTypesObj).concat(['ExpandAll']);
	        var page = this.state.page;
	        var activeCards = this.state.activeCards.cards;
	        var abouts = this.state.abouts;
	        var cvLink = this.state.cvLink;
	        return _react2.default.createElement(
	            'div',
	            { id: 'wrapper' },
	            _react2.default.createElement(_headerNav2.default, { curPage: page, sections: cardTypes, cvLink: cvLink }),
	            _react2.default.createElement(_mainSection2.default, { page: page, activeCards: activeCards, abouts: abouts })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _creator = __webpack_require__(161);
	...
	var Page = function () {
	    function Page(data) {
	        ...
	        this.Handler = {
	            LOAD_PAGE: function LOAD_PAGE(action) {
	        ...
	        _creator.Dispatcher.register(function (action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.Actions = exports.Dispatcher = undefined;
	...
	var Actions = exports.Actions = {
	    loadCollection: function loadCollection(name) {
	        $('body').scrollTop(0);
	        Dispatcher.dispatch({
	            type: 'LOAD_PAGE',
	            data: {
	    ...
	    toggleDetails: function toggleDetails(type, title) {
	        Dispatcher.dispatch({
	            type: 'TOGGLE_DETAILS',
	            data: {
	                type: type,
	...
	var Cards = function () {
	    function Cards(data) {
	        ...
	        this.Handler = {
	                ...
	                if (pageType === 'collection') {
	                    switch (pageName) {
	                        ...
	                        case 'Trending':
	                            ...
	                            break;
	                        case 'Fresh':
	                            var strToDate = function strToDate(mY) {
	            ...
	            TOGGLE_DETAILS: function TOGGLE_DETAILS(action) {
	                var self = this;
	            ...
	            TOGGLE_EXPAND_ALL: function TOGGLE_EXPAND_ALL(action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function App(state) {
	    ...
	    this.page = new _page2.default(state.page);
	    this.cvLink = state.cvLink;
	    this.abouts = state.abouts;
	    this.cards = state.cards;
	    this.activeCards = new _cards2.default(state.cards);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var HeaderNav = _react2.default.createClass({
	    ...
	    render: function render() {
	        var cvLink = this.props.cvLink;
	        var curPageName = (this.props.curPage || {}).name;
	        var onLinkClick = this.onLinkClick;
	        var sections = this.props.sections || [];
	        var sectionsLink = sections.map(function (v) {
	            var sec = v !== 'ExpandAll' ? v : 'ಠ_ಠ';
	            return _react2.default.createElement(
	                'li',
	                { key: v },
	                _react2.default.createElement(
	                    'a',
	                    { href: '#', 'data-page': v, onClick: onLinkClick },
	                    sec
	                )
	            );
	        });
	        return _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'navbar-brand', href: '#', 'data-page': 'Hot', onClick: onLinkClick },
	                        _react2.default.createElement('img', { alt: 'Franky Lau CV', src: 'img/cv-logo.png' })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'nav navbar-nav primary' },
	                        ['Hot', 'Trending', 'Fresh'].map(function (v) {
	                            return _react2.default.createElement(
	                                'li',
	                                { key: v, className: curPageName === v ? 'active' : '' },
	                                _react2.default.createElement(
	                                    'a',
	                                    { href: '#', 'data-page': v, onClick: onLinkClick },
	                                    v
	                    ...
	                    _react2.default.createElement(
	                        'ul',
	                        { className: 'nav navbar-nav visible-lg-block visible-md-block visible-xs-block' },
	                        sectionsLink,
	                        _react2.default.createElement(
	                            'li',
	                    ...
	                    _react2.default.createElement(
	                        'form',
	                        { className: 'navbar-form navbar-right hidden-xs', role: 'download' },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'visible-lg-inline-block visible-sm-inline-block' },
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', className: 'btn btn-mute' },
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { className: 'btn btn-primary-flat visible-lg-inline-block visible-md-inline-block visible-sm-inline-block',
	                                href: cvLink,
	                                target: '_blank' },
	                            _react2.default.createElement(
	                                'div',
	    ...
	    onLinkClick: function onLinkClick(event) {
	        ...
	        var page = $target.data('page') || 'Hot';
	        if (page === 'ExpandAll') {
	            _creator.Actions.toggleExpandAll();
	        } else {
	            _creator.Actions.loadCollection(page);
	        }
	        event.preventDefault();
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sideSection = __webpack_require__(169);

	var _sideSection2 = _interopRequireDefault(_sideSection);

	var _collectionSection = __webpack_require__(171);

	var _collectionSection2 = _interopRequireDefault(_collectionSection);

	var _detailsSection = __webpack_require__(173);

	var _detailsSection2 = _interopRequireDefault(_detailsSection);
	...
	var MainSection = function MainSection(props) {
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'container' },
	        _react2.default.createElement(_sideSection2.default, { abouts: abouts }),
	        pageType === 'collection' ? _react2.default.createElement(_collectionSection2.default, { cards: activeCards }) : _react2.default.createElement(_detailsSection2.default, { cards: activeCards })
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socialMediaButton = __webpack_require__(170);

	var _socialMediaButton2 = _interopRequireDefault(_socialMediaButton);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var SideSection = function SideSection(props) {
	    var abouts = props.abouts || {};
	    var details = abouts.details || [];
	    var skillCompUl = [];
	    var skillCompFlat = [];
	    Object.keys(abouts.skills).forEach(function (key) {
	        skillCompFlat.push(_react2.default.createElement(
	            'div',
	            { key: key, className: 'container' },
	            _react2.default.createElement(
	                'div',
	                { className: 'col-xs-3' },
	                key
	            ...
	            _react2.default.createElement(
	                'div',
	                { className: 'col-xs-9' },
	                abouts.skills[key].join(', ')
	            )
	        ));
	        skillCompUl.push(_react2.default.createElement(
	            'li',
	            { key: key },
	            _react2.default.createElement(
	                'div',
	    ...
	    return _react2.default.createElement(
	        'div',
	        { className: 'side pull-right' },
	        _react2.default.createElement(
	            'div',
	            { className: 'abouts-item profile' },
	            _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(
	                ...
	                _react2.default.createElement('img', { src: 'img/content/' + abouts.profilePic, className: 'profilePic hidden-xs hidden-sm' }),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'buttons-bar' },
	                    abouts.links.map(function (v) {
	                        return _react2.default.createElement(_socialMediaButton2.default, { key: v.type + v.url, type: v.type, url: v.url });
	                    }).reduce(function (p, c, i) {
	                        if (i > 0) {
	                            p.push(_react2.default.createElement('span', { key: 'spacer' + i, className: 'spacer' }));
	                        }
	                        p.push(c);
	                        return p;
	                    }, [])
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    ' style, does it look cool and fun?'
	                ),
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    'The key technologies involve in this website are: jQuery, Bootstrap, ReactJs+Flux.'
	                )
	            )
	        ),
	        _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SocialMediaButton = function SocialMediaButton(props) {
	    var name = props.type || '';
	    ...
	    return _react2.default.createElement(
	        'a',
	        { href: url, className: css, target: '_blank' },
	        img ? _react2.default.createElement('img', { src: img, title: name, alt: name }) : null,
	        name
	    );
	};

	exports.default = SocialMediaButton;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionCard = __webpack_require__(172);

	var _collectionCard2 = _interopRequireDefault(_collectionCard);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var CollectionSection = function CollectionSection(props) {
	    var cards = props.cards || [];
	    var cardsEl = cards.map(function (v) {
	        return _react2.default.createElement(_collectionCard2.default, { key: v.type + v.title, content: v });
	    });

	    return _react2.default.createElement(
	        'div',
	        { className: 'main pull-left' },
	        cardsEl
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CollectionCard = _react2.default.createClass({
	    displayName: 'CollectionCard',

	    render: function render() {
	        var content = this.props.content || {};
	        var date = (content.time.from == null ? 'Past' : content.time.from) + ' - ' + (content.time.to == null ? 'Present' : content.time.to);
	        return _react2.default.createElement(
	            'article',
	            { className: 'card' },
	            _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: '#', onClick: this.onLinkClick },
	                        _react2.default.createElement('img', { src: "img/content/" + content.image })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: '#', className: 'btn btn-default-flat', onClick: this.onLinkClick },
	            ...
	            content.showDetails ? _react2.default.createElement(_detailsSection2.default, { details: content.details }) : null
	        );
	    },

	    onLinkClick: function onLinkClick(event) {
	        _creator.Actions.toggleDetails(this.props.content.type, this.props.content.title);
	        event.preventDefault();
	    }
	});
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            details.map(function (v) {
	                var html = { "__html": v };
	                return _react2.default.createElement('div', { key: v, className: 'details-item', dangerouslySetInnerHTML: html });
	            })
	        )
	    );
	};
